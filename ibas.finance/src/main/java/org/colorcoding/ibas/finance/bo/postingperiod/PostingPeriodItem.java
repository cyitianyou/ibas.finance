...
@XmlType(name = PostingPeriodItem.BUSINESS_OBJECT_NAME, namespace = MyConfiguration.NAMESPACE_BO)
public class PostingPeriodItem extends BusinessObject<PostingPeriodItem> implements IPostingPeriodItem {
	 ...
	 * 当前类型
	 */
	private static final Class<?> MY_CLASS = PostingPeriodItem.class;

	/**
	 * 数据库表
	 */
	public static final String DB_TABLE_NAME = "${Company}_FI_PPD1";
