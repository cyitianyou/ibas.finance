package org.colorcoding.ibas.finance.bo.dimension;
...
import org.colorcoding.ibas.finance.data.emDimensionSource;
...
@BOCode(Dimension.BUSINESS_OBJECT_CODE)
public class Dimension extends BusinessObject<Dimension> implements IDimension {

	/**
	 * 序列化版本标记
	 */
	private static final long serialVersionUID = 9016019439130605834L;

	/**
	 * 当前类型
	 */
	private static final Class<?> MY_CLASS = Dimension.class;

	/**
	 * 数据库表
	 */
	public static final String DB_TABLE_NAME = "${Company}_FI_ODIM";

	/**
	 * 业务对象编码
	 */
	public static final String BUSINESS_OBJECT_CODE = "${Company}_FI_DIMENSION";

	/**
	 * 业务对象名称
	 */
	public static final String BUSINESS_OBJECT_NAME = "Dimension";
	...
	public static final IPropertyInfo<emDimensionSource> PROPERTY_SOURCETYPE = registerProperty(
			PROPERTY_SOURCETYPE_NAME, emDimensionSource.class, MY_CLASS);
	...
	public final emDimensionSource getSourceType() {
	 ...
	 * @param value 值
	 */
	public final void setSourceType(emDimensionSource value) {
	 ...
	 * 来源 属性
	 */
	@DbField(name = "Source", type = DbFieldType.ALPHANUMERIC, table = DB_TABLE_NAME, primaryKey = false)
