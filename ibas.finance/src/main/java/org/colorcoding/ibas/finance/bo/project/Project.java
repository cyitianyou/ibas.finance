package org.colorcoding.ibas.finance.bo.project;
...
public class Project extends BusinessObject<Project>
		implements IProject, IDataOwnership, IBOSeriesKey, IBOTagDeleted, IBOUserFields {

	/**
	 * 序列化版本标记
	 */
	private static final long serialVersionUID = -2862046932769719546L;
	 ...
	 * 数据库表
	 */
	public static final String DB_TABLE_NAME = "${Company}_FI_OPRJ";

	/**
	 * 业务对象编码
	 */
	public static final String BUSINESS_OBJECT_CODE = "${Company}_FI_PROJECT";
