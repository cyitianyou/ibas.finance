...
namespace finance {
    export namespace app {
        /** 列表应用-项目 */
        export class ProjectListApp extends ibas.BOListApplication<IProjectListView, bo.Project> {
            /** 应用标识 */
            static APPLICATION_ID: string = "09a6886b-9110-4ace-bf84-be393b78b02d";
            /** 应用名称 */
            static APPLICATION_NAME: string = "finance_app_project_list";
            /** 业务对象编码 */
            static BUSINESS_OBJECT_CODE: string = bo.Project.BUSINESS_OBJECT_CODE;
            /** 构造函数 */
            constructor() {
                super();
                this.id = ProjectListApp.APPLICATION_ID;
                this.name = ProjectListApp.APPLICATION_NAME;
                this.boCode = ProjectListApp.BUSINESS_OBJECT_CODE;
