...
namespace finance {
    export namespace bo {
        /** 项目 */
        export class Project extends ibas.BOMasterData<Project> implements IProject {
            /** 业务对象编码 */
            ...
            get referenced(): ibas.emYesNo {
                return this.getProperty<ibas.emYesNo>(Project.PROPERTY_REFERENCED_NAME);
            }
            /** 设置-已引用 */
            ...
            get deleted(): ibas.emYesNo {
                return this.getProperty<ibas.emYesNo>(Project.PROPERTY_DELETED_NAME);
            }
            /** 设置-删除的 */
